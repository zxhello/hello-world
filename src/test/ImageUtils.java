...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        ...
        // 方法二：按高度和宽度缩放
        ImageUtils.scaleByWidthAndHeight("e:/abc.jpg", "e:/abc_scale2.jpg", 256, 200, false);//测试OK
...
//        ImageUtils.pressImage("e:/abc2.jpg", "e:/abc.jpg","e:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
     ...
     */
    public final static void scaleByWidthAndHeight(String srcImageFile, String result, int width, int height, boolean bb) {
        try {
